    ...
    <x-auth-card>
        ...
        <form method="POST" action="{{ route('register.store') }}">
            ...
            <div class="mt-4">
                ...
                <x-input id="empresa" class="block w-full mt-1" type="text" name="empresa" :value="old('empresa')" required autofocus />
            </div>
            ...
            <div class="mt-4">
                ...
                <x-input id="cnpj" class="block w-full mt-1" type="text" name="cnpj" :value="old('cnpj')" required autofocus />
            </div>
